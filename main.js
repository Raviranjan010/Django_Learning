...
//     // Glass card style
//     div.className = `group relative bg-slate-900/40 backdrop-blur-sm border rounded-2xl p-6 hover:border-emerald-500/50 hover:shadow-2xl hover:shadow-emerald-900/20 transition-all duration-300 transform hover:-translate-y-1 ${isCompleted ? 'border-emerald-500/30 bg-emerald-900/5' : 'border-slate-800'}`;
...
//                 class="w-9 h-9 rounded-xl flex items-center justify-center transition-all ${isCompleted
...
//                 class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 hover:text-white text-xs font-bold text-white transition-all duration-300 border border-emerald-500 shadow-lg shadow-emerald-900/20 group-hover:scale-105">
//                 <span>Start</span>
